...
enum : uint16_t
{
	...
	STR_RIDE_NAME_STEEL_SPINNING_ROLLER_COASTER = 98,
    STR_RIDE_NAME_VEKOMA_MINE_ROLLER_COASTER = 99,
    STR_RIDE_NAME_HYDRAULIC_LAUNCHED_ROLLER_COASTER = 100,
    ...
    STR_RIDE_DESCRIPTION_STEEL_SPINNING_ROLLER_COASTER = 608,
    STR_RIDE_DESCRIPTION_VEKOMA_MINE_ROLLER_COASTER = 609,
    STR_RIDE_DESCRIPTION_HYDRAULIC_LAUNCHED_ROLLER_COASTER = 610,

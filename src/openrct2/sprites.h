...
enum
{
    ...
    SPR_G2_T_REX_TRACK_GENTLE = SPR_G2_T_REX_TRACK_BLOCK_BRAKE + 2,
    ...
    SPR_G2_T_REX_TRACK_FLAT_TO_STEEP = SPR_G2_T_REX_TRACK_HALF_LOOP + 16,
    ...
    SPR_G2_T_REX_LIFT_TRACK_FLAT_DIAGONAL = SPR_G2_T_REX_LIFT_TRACK_STEEP + 16,
    ...
    SPR_G2_ICON_PALETTE_INVISIBLE = SPR_G2_T_REX_END,

...
enum
{
    ...
    SPR_G2_PALETTE_END = SPR_G2_PAL_GLASS_VOID + 1,

    SPR_G2_GIGA_TRACK_VERTICAL = SPR_G2_PALETTE_END,
    ...
    SPR_G2_MINI_TRACK_VERTICAL = SPR_G2_GIGA_END,
    ...
    SPR_G2_MINI_END = SPR_G2_MINI_TRACK_GENTLE_LARGE_CURVE_BANKED + 128,

    SPR_G2_END = SPR_G2_MINI_END,

...
enum
{
    ...
    SPR_G2_VEKOMA_MINE_TRACK_POWERED_LIFT = SPR_G2_VEKOMA_MINE_TRACK_GENTLE_LARGE_CURVE_BANKED + 128,
   
    SPR_G2_VEKOMA_MINE_LIFT_BEGIN = SPR_G2_VEKOMA_MINE_TRACK_POWERED_LIFT + 4,

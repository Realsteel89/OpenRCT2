...
// clang-format off
constexpr RideTypeDescriptor VekomaMineRollerCoasterRTD =
{
    .Category = RIDE_CATEGORY_ROLLERCOASTER,
    .StartTrackPiece = OpenRCT2::TrackElemType::EndStation,
    .TrackPaintFunctions = TrackDrawerDescriptor({
        .Drawer = OpenRCT2::VekomaMineRC::GetTrackPaintFunction,
        .supportType = MetalSupportType::Tubes,
        .EnabledTrackPieces = {TrackGroup::straight, TrackGroup::stationEnd, TrackGroup::liftHill, TrackGroup::flatRollBanking, TrackGroup::slope, TrackGroup::slopeSteepUp, TrackGroup::slopeSteepDown, TrackGroup::slopeCurve, TrackGroup::slopeCurveSteep, TrackGroup::sBend, TrackGroup::curveSmall, TrackGroup::curve, TrackGroup::curveLarge, TrackGroup::halfLoop},
        .ExtraTrackPieces =  {TrackGroup::slopeSteepLong},
        }),
    ...
    .Naming = { STR_RIDE_NAME_VEKOMA_MINE_TRAIN_ROLLER_COASTER, STR_RIDE_DESCRIPTION_VEKOMA_MINE_TRAIN_ROLLER_COASTER},
    ...
    /*
    .ColourPreview = { SPR_RIDE_DESIGN_PREVIEW_VEKOMA_MINE_ROLLER_COASTER_TRACK, SPR_RIDE_DESIGN_PREVIEW_VEKOMA_MINE_ROLLER_COASTER_SUPPORTS },
    */
